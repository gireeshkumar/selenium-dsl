...
public abstract class AbstractPageDriver {
	...
	private static final long TIMEOUT_MILLIS = 6000 * 5;//Wait for MAX 5 mnt for loading the page and making object visible//10000L;
	
	protected final FlexSelenium flexSelenium;
...
//		ensureDataGridRowVisible(widgetId, field, value, true);
	...
	public void captureScreenShot(final String fileName) {
		flexSelenium.captureScreenshot(fileName + ".png");
	}
