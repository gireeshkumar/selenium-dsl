 ...
 *
 */
public class GetCommandProcessor implements ICommandProcessor, IFlexCommandProcessor {

	public static final String GET_CMD = "get";
	
	static{
		new GetCommandProcessor();
	}
...
//		driver.click(command.getLocator());
		return driver.getFlexSelenium().call(command.getCommand(), command.getLocator(), command.getArgs());
	}
