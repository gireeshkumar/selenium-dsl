 ...
 *
 */
public class GetFlexVisibleAssertionProcessor implements IAssertionProcessor , IFlexCommandProcessor{

	public static final String GET_FLEX_VISIBLE_CMD = "getFlexVisible";
	
	static{
		new GetFlexVisibleAssertionProcessor();
	}
	
	private GetFlexVisibleAssertionProcessor(){
	...
	public String process(ISeleniumTestRunner testRunner, final WebDriver webdriver, final TARGetPageDriver driver, final ICommand command) {
		...
		driver.ensureWidgetVisibility(command.getLocator(), 
	...
	public String[] supportedCommands() {
		return new String[]{GET_FLEX_VISIBLE_CMD};
	}
