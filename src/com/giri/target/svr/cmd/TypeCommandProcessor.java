 ...
 *
 */
public class TypeCommandProcessor implements ICommandProcessor , IFlexCommandProcessor{

	public static final String TYPE_CMD = "type";
	
	static{
		new TypeCommandProcessor();
	}
	
	private TypeCommandProcessor() {
	...
	public String process(ISeleniumTestRunner testRunner, final WebDriver webdriver, final TARGetPageDriver driver, final ICommand command) {
		...
		driver.enterText(command.getLocator(), command.getArgs());
		return null;
	}
