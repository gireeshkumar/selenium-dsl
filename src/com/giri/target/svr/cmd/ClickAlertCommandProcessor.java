 ...
 *
 */
public class ClickAlertCommandProcessor implements ICommandProcessor, IFlexCommandProcessor {

	public static final String CLICK_ALERT_CMD = "clickAlert";
	static{
		new ClickAlertCommandProcessor();
	}

	private ClickAlertCommandProcessor() {
	...
	public String[] supportedCommands() {
		return (new String[]{CLICK_ALERT_CMD});
	}
	...
	public String process(ISeleniumTestRunner testRunner, final WebDriver webdriver, final TARGetPageDriver driver, final ICommand command) {
		return driver.getFlexSelenium().clickAlert(command.getArgs());
	}
