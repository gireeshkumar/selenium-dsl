 ...
 *
 */
public class IsAlertVisibleAssertionProcessor implements IAssertionProcessor , IFlexCommandProcessor{

	public static final String IS_ALERT_VISIBLE_CMD = "isAlertVisible";
	
	static{
		new IsAlertVisibleAssertionProcessor();
	}
	
	private IsAlertVisibleAssertionProcessor(){
	...
	public String process(ISeleniumTestRunner testRunner, final WebDriver webdriver, final TARGetPageDriver driver, final ICommand command) {
		return "" + driver.getFlexSelenium().isAlertVisible();
	}
	...
	public String[] supportedCommands() {
		return new String[]{IS_ALERT_VISIBLE_CMD};
	}
